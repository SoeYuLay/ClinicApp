...
class DoctorServices {
  ...
  static Future<List<Doctor>> fetchDoctorDataBySpeciality({
    required String accessToken,
    required String specialityID
  }) async {
    try {
      final response = await http.get(
        Uri.parse("$baseUrl/doctors/specialty/$specialityID"),
        headers: {
          "Content-Type": "application/json",
          "Accept": "application/json",
          "Authorization": "Bearer $accessToken"
  ...
  static Future<List<Doctor>> fetchDoctorBySearch({
    required String accessToken,
    required String doctorName,
    required String date
  }) async {
    try {
      final url = doctorName == '' ? "$baseUrl/doctors?date=$date" : "$baseUrl/doctors?name=$doctorName";
      final response = await http.get(
        Uri.parse(url),
        headers: {
          "Content-Type": "application/json",
  ...
  static Future<List<Doctor>> fetchFavoriteDoctor({
    required String accessToken
  }) async {
    try {
      final response = await http.get(
        Uri.parse("$baseUrl/doctors?favoritesOnly=true"),
        headers: {
          "Content-Type": "application/json",
          "Accept": "application/json",
          "Authorization": "Bearer $accessToken"
