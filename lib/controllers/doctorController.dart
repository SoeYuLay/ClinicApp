...
class DoctorController extends GetxController{
  ...
  //
  //   final result = await DoctorServices.fetchDoctorData(token: accessToken, isHomePage: isHomePage);
  //
  ...
  //   errorMessage.value = '';
  //
  //   final result = await DoctorServices.fetchDoctorDataByID(accessToken: accessToken, doctorID: doctorID);
  //   doctor.value = result;
  //
  //   isLoading.value = false;
  // }
