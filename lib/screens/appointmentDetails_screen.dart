...
class AppointmentDetailsScreen extends StatefulWidget {
  const AppointmentDetailsScreen({required this.appointmentID,super.key});
...
class _AppointmentDetailsScreenState extends State<AppointmentDetailsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.fetchAppointmentByID(widget.appointmentID);
    });
  }
    ...
    return Scaffold(
        ...
        body: SafeArea(
            child: Obx((){
              ...
              final appointmentDetail = controller.appointmentDetail.value;
                            ...
                            child: Column(
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(appointmentDetail.doctor.imageUrl,
                                ...
                                Text(
                                  appointmentDetail.doctor.speciality,
                                  style: TextStyle(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        StatusChip(status: appointmentDetail.appointmentStatus),
                                        Text(
                                          'Appointment Detail',
                                          style: TextStyle(
                                        ...
                                        const SizedBox(height: 5),
                                        Text(
                                          '${appointmentDetail.appointmentType} appointment',
                                          style: TextStyle(
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text(DateFormat('d MMM, y').format(appointmentDetail.appointmentDate),
                                                style: TextStyle(
                                                    color: Colors.grey,fontWeight: FontWeight.bold,
                                                    fontSize: 15)),
                                            const SizedBox(width: 10),
                                            Text('●  ${appointmentDetail.timeSlot}',
                                                style: TextStyle(
