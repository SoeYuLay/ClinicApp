            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    appointmentResponse.successText,
                        ...
                        child: Column(
                          children: [
                            ClipRRect(
                              ...
                              child: Image.network(
                                  appointmentResponse.doctor.imageUrl ?? '',
                                  // width: 110, height: 110
                              ),
                            ),
                            const SizedBox(height: 5),
                            Text(
                              appointmentResponse.doctor.name ?? '',
                              style: TextStyle(
                            ...
                            Text(
                              appointmentResponse.doctor.speciality ?? '',
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 5),
                                      Text(
                                        '${appointmentResponse.appointmentType} Appointment',
                                        style: TextStyle(
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(DateFormat('d MMM, y').format(appointmentResponse.appointmentTime.date),
                                              style: TextStyle(
                                                  color: Colors.grey,fontWeight: FontWeight.bold,
                                                  fontSize: 15)),
                                          const SizedBox(width: 10),
                                          Text('●  ${appointmentResponse.appointmentTime.timeslot ?? ''}',
                                              style: TextStyle(
